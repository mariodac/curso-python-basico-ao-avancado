...
# planilha (Google Sheets, Excel, LibreOffice Calc, etc) ou para uma base de dados.
...
# linhas seguintes contém os valores das linhas, separados por vírgulas.
...
PATH_CSV = Path(__file__).parent / 'aula292.csv'
